      ...
      <DrawerContent className="bg-gray-900 text-white">
        ...
        <div className="px-4 pb-4">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent className="bg-gray-800 border-gray-700 text-white">
                  <SelectItem value="CURRENT" className="focus:bg-gray-700">Current</SelectItem>
                  <SelectItem value="SAVINGS" className="focus:bg-gray-700">Savings</SelectItem>
                </SelectContent>
              </Select>
              {errors.type && (
            ...
            <div className="flex gap-4 pt-4">
              <DrawerClose asChild>
                <Button type="button" variant="outline" className="flex-1 bg-inherit border-gray-700 text-gray-300 hover:bg-gray-800 hover:text-white">
                  Cancel
                </Button>
              </DrawerClose>
              <Button
                type="submit"
                className="flex-1 bg-gradient from-blue-700 to-purple-700 hover:bg-blue-700 text-white"
                disabled={createAccountLoading}
              >
                {createAccountLoading ? (
                  <>
